...
\begin{frame}{Intermediate Task: Linked List Insertion}
    ...
    \code{Lesson 5 Intermediate Task Starting Point: Linked List Insertion}
   
    on our site (\url{https://jkrbs.github.io/c_lessons}).

    \begin{itemize}
		\item Task A: Write the function \code{list_insert} and test if your code works!
        ...
        \begin{itemize}
            ...
            \item \code{list.h} which forward declares our list interface.
             \item Try to use the library from \code{main.c}!
